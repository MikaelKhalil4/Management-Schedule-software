...
namespace MKproject
{
    internal static class Program
    {
        ...
        //         vpk download http --url https://cdn.foxdigitaltech.online/fox-global
        //         vpk pack -u FoxApp -v 1.0.22 -p./bin/Publish/win-x64 -e MKproject.exe  --channel win-x64 --packTitle "Fox" --icon images/foxlogo.ico --splashImage images/foxlogo.ico 
